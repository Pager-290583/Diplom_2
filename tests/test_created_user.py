...
@allure.feature("Регистрация юзера")
class TestCreateCourier:
    @allure.story("POST запрос на регистрацию нового юзера")
    ...
    @allure.description("Ответы системы на невалидные данные: success: False")
    @allure.tag("NewAPI", "Essentials", "CreatUser")
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.label("owner", "Kozlov Oleg")
    @allure.link("https://stellarburgers.nomoreparties.site", name="Website")
